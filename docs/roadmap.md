...
- [x] Proxmox-Grundstruktur dokumentiert
- [x] Storage, Monitoring, Docker Services und Automation rollenbasiert getrennt
...
- [ ] Prometheus installieren und als Grafana-Datenquelle anbinden
- [ ] Node Exporter auf relevanten Linux-Systemen ergänzen
- [ ] erstes Grafana-Dashboard erstellen und exportieren
- [ ] Uptime-Kuma-Checks dokumentieren
